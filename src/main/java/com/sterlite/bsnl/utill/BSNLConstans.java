...
public class BSNLConstans {
	...
	public static final String sqlSingleBNGIAndCStatus = "select B.STAGENAME,A.STATUS,A.CLOSEDATE,A.TARGETDATE,B.ORDERID,A.bngid from \r\n"
			+ "TBLBNGINSTANDCOMMISTAGE A, TBLBNGINSTANDCOMMISTAGEODER B where B.STAGEID=A.STAGEID and A.bngid= :bngid  ";
	
	public static final String sqlSingleBNGInvStatus = "select B.STAGENAME,A.STATUS,A.CLOSEDATE,A.TARGETDATE, A.JV,B.ORDERID,A.bngid  from TBLBNGINVOICEANFAPYMENTSTAGE A, TBLBNGINVOICEANDPAYMENTSTAGEODER B where B.STAGEID=A.STAGEID and A.bngid= :bngid";
